...
DATA_URI=(home+"/Documents/Gabriel/Coursera/Streamlit-course/Tweets.csv")
...
choice = st.sidebar.multiselect('Pick airliness', ('US Airways','United', 'American', 'Southwest', 'Delta', 'Virgin America'), key='0')
